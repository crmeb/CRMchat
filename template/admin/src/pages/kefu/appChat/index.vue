            ...
            <div class="editor-hd">
              <div>
                ...
                <button title="图片" v-if="kufuToken">
                  <Upload :show-upload-list="false" :action="uploadAction" :before-upload="beforeUpload" :format="['jpg','jpeg','png','gif']" :on-format-error="handleFormatError" :data="uploadData" :on-success="uploadSuccess" :on-error="uploadError">
